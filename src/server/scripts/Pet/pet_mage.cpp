...
struct npc_pet_mage_mirror_image : CasterAI
{
    ...
    void MySelectNextTarget()
    {
        ...
        Unit* owner = me->GetOwner();
        if (owner && owner->IsPlayer() && (!me->GetVictim() || (me->GetVictim()->IsImmunedToSpell(sSpellMgr->GetSpellInfo(59637)) && me->GetVictim()->IsImmunedToSpell(sSpellMgr->GetSpellInfo(59638)) ) || !me->IsValidAttackTarget(me->GetVictim()) ))
        {
